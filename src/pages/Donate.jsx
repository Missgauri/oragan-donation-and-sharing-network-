...
const Donate = () => {
  const { formData, submitted, handleChange, handleSubmit, reset } = useDonorForm();
    ...
    return (
      <div className="donate-page success-view container">
        <div className="success-card glass-panel text-center">
          ...
          <p>
            Your donor profile has been securely created. You are now part of the LifeGift
            Network and will be notified if a match is found.
          </p>
    ...
    <div className="donate-page container">
      ...
      <div className="donate-header text-center">
        ...
        <p className="page-subtitle">
          Your decision can save up to 8 lives. Please fill out your details securely below.
        </p>
      </div>
        ...
        <form className="donate-form" onSubmit={handleSubmit}>
          ...
          <div className="form-group">
            ...
            <textarea
              ...
              placeholder="Please list any preexisting medical conditions..."
              required
            />
          </div>
          ...
          <div className="form-group checkbox-group">
            <label className="checkbox-label">
              ...
              />
              <span>
                I confirm that the provided information is correct and I consent to joining
                the LifeGift Donor Registry.
              </span>
            </label>
          </div>
